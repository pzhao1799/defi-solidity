...
//TODO: change these addresses to traderjoe
contract APExchangeHelper {
    ...
    function getFee(uint256 _amount, address _user, address _token, uint256 _apFeeDivider) internal returns (uint256 feeAmount) {
